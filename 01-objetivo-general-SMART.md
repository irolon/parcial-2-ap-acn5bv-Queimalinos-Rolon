...
*Documento bajo control de versiones (gestión de la configuración). Entregable **v4.0** del proyecto: objetivo general (SMART) + análisis de interesados + metodología de trabajo (Kanban) + análisis de requerimientos (historias de usuario).*
